...
export function initWelcome(params) {
  ...
  div.innerHTML = `
    ...
    <custom-text class="texto" variant="title"> Piedra Papel o Tijera </custom-text>
     <button-blue class="boton" >Nuevo Juego</button-blue>
    <button-blue class="btn2" >Ingresar a una sala</button-blue> 
  ...
  const btn1 = div.querySelector(".btn2");
  console.log(btn1);
  btn1.addEventListener("click", () => {
    params.goTo("/select-room");
  });
